...
window.addEventListener("scroll", function () {
	...
	const wght = 100 + pixels * 0.7; // In die const namens "wght" wird die Rechnung 100 + der Wert der Y-Achse x 0.4 gespeichert.
	const wdth = 100 + pixels * 0.7; // In die const namens "wdth" wird die Rechnung 100 + der Wert der Y-Achse x 0.1 gespeichert.
